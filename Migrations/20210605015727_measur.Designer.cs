...
namespace Pos.Migrations
{
    ...
    [Migration("20210605015727_measur")]
    partial class measur
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeasurmentsProductsMeasurments", b =>
                {
                    b.Property<int>("MeasurmentsId")
                        .HasColumnType("int");

                    b.Property<int>("ProductsMeasurmentsProductId")
                        .HasColumnType("int");

                    b.Property<int>("ProductsMeasurmentsMeasurmentId")
                        .HasColumnType("int");

                    b.HasKey("MeasurmentsId", "ProductsMeasurmentsProductId", "ProductsMeasurmentsMeasurmentId");

                    b.HasIndex("ProductsMeasurmentsProductId", "ProductsMeasurmentsMeasurmentId");

                    b.ToTable("MeasurmentsProductsMeasurments");
                });
            ...
            modelBuilder.Entity("ProductsProductsMeasurments", b =>
                {
                    ...
                    b.HasKey("ProductsId", "ProductsMeasurmentsProductId", "ProductsMeasurmentsMeasurmentId");

                    b.HasIndex("ProductsMeasurmentsProductId", "ProductsMeasurmentsMeasurmentId");

                    b.ToTable("ProductsProductsMeasurments");
                });

            modelBuilder.Entity("MeasurmentsProductsMeasurments", b =>
                {
                    b.HasOne("Pos.Models.Measurments", null)
                        .WithMany()
                        .HasForeignKey("MeasurmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pos.Models.ProductsMeasurments", null)
                        .WithMany()
                        .HasForeignKey("ProductsMeasurmentsProductId", "ProductsMeasurmentsMeasurmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProductsProductsMeasurments", b =>
                {
                    b.HasOne("Pos.Models.Products", null)
                        .WithMany()
